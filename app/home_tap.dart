...
class _AttendanceViewState extends State<AttendanceView> {
  bool _isInLab = true;
  String _timestamp = "마지막 체크인: 오늘 19:50";
        ...
        Expanded(
          child: OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
              foregroundColor: !_isInLab ? Colors.grey[400] : Colors.black54,
  ...
  Widget _buildToggleSwitch() {
    return Row(
      ...
      children: [
        const Text("직접 상태 변경", style: TextStyle(fontSize: 16, color: Colors.black54)),
        Switch(
          value: _isInLab,
